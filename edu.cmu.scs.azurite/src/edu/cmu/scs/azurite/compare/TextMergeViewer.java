 ...
 */
@SuppressWarnings({ "restriction", "deprecation", "rawtypes", "unchecked" })
public class TextMergeViewer extends ContentMergeViewer implements IAdaptable {
	...
	private String getDiffType(Diff diff) {
		...
		return MessageFormat.format(format, (Object[]) new String[] { s, diff.changeType() } );
	}
	...
	private String getDiffRange(MergeSourceViewer v, Position pos) {
		...
		return MessageFormat.format(format,
				(Object[]) new String[] { Integer.toString(startLine),
		...
		if (v != null) {
			...
			if (document != null) {
				...
				try {
					...
					return MessageFormat.format(format,
							(Object[]) new String[] { Integer.toString(line + 1), Integer.toString(column + 1) } );
